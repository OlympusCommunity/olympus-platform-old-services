					...
					<div class="form-group row">
						...
						<?php
      					...
      					?>
      						...
      						<div class="form-check">
        					<input class="form-check-input" type="checkbox" id="gridCheck1" value="<?php echo $f_cat['id_tema'] ?>">
        					<label class="form-check-label" for="gridCheck1"><?php echo $f_cat['tematica'] ?></label>
      						</div>
