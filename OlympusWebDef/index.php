		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active">
				...
				<div class="carousel-caption">
					...
					<button type="button" class="btn btn-success"><a href="inicio/inicio.php">ENTRAR</a></button>
				</div>
			</div>
			...
			<div class="carousel-item">
				...
				<div class="carousel-caption">
					...
					<p>Bienvenidos a la red de grupos de WhatsApp más grande del mundo.</p>
					<button type="button" class="btn btn-primary"><a href="login/sign_up.php">REGÍSTRATE</a></button>
					<button type="button" class="btn btn-success"><a href="login/sign_in.php">INICIAR SESIÓN</a></button>
				</div>
			</div>
			...
			<div class="carousel-item">
				...
				<div class="carousel-caption">
					...
					<p>Bienvenidos a la red de grupos de WhatsApp más grande del mundo.</p>
					<button type="button" class="btn btn-success"><a href="login/sign_in.php">INICIAR</a></button>
				</div>
			</div>
