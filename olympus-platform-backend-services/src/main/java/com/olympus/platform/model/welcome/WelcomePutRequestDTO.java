...
public class WelcomePutRequestDTO {
  ...
  @NotNull(message = "welcomeId" + ValidationConstant.MESSAGE_NOT_NULL)
  @NotBlank(message = "welcomeId" + ValidationConstant.MESSAGE_NOT_BLANK)
  @NotEmpty(message = "welcomeId" + ValidationConstant.MESSAGE_NOT_EMPTY)
